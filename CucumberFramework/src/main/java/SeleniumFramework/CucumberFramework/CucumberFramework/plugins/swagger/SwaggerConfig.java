 ...
 * All right reserved. 
 */
package SeleniumFramework.CucumberFramework.CucumberFramework.plugins.swagger;
...
public class SwaggerConfig {
	...
	public static String CONTROLLER_URL="SeleniumFramework.CucumberFramework.CucumberFramework.controller";    //Swagger扫描的接口路径
